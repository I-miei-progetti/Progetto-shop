<nav class="navbar navbar-expand-lg">
    <div class="container-fluid navbar">
        <button class="navbar-toggler mx-3" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo03"
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('component.indice') }}">Componentistica</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" data-bs-popper="static">
                        ...
                        <li><a class="dropdown-item" href="{{ route('car.user') }}">Le tue auto</a></li>
                    </ul>
                </li>
                ...
                <div class="d-flex align-items-center gap-4 me-4">
                    @guest {{-- inserisco qui il @guest così che quando mi collego o mi registro scompare il dropdown per accedere e registrarsi --}}
                        <div class="nav-item dropstart">
                            ...
                            <ul class="dropdown-menu mt-4" data-bs-popper="static">
